...
contract CoinEht // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x61c2640482d18afFf0d79b0C36613553B384C129; // @eachvar
    address public account_address = 0x61c2640482d18afFf0d79b0C36613553B384C129; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "Enjoy happiness token"; // @eachvar
    string public symbol = "EHT"; // @eachvar
    ...
    address public air_drop_address = 0xf0536aeE584aA9Eb0465b4173404647227166675; // 用于发放空投代币的账户 @eachvar
    ...
    uint256 public air_drop_range_start = 1541656860; // 有效期开始 @eachvar
    uint256 public air_drop_range_end = 1573192860; // 有效期结束 @eachvar
